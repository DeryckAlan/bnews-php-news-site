...
//fetch all posts from postss table
$query = "SELECT * FROM posts ORDER BY dste_time DESC";
$posts = mysqli_query($connection, $query);
?>


	<section class="search__bar">
		<form class="conteiner search__bar-conteiner" action="<?= ROOT_URL ?>search.php" method="GET">
			<div>
				<input type="search" name="search" placeholder="search">
			</div>
			<button type="submit" name="submit" class="btn"><img src="./images/find.png"></button>
		</form>
	</section>

	<!--------------END OF SEARCH SERCTION--------------->
