		...
		if($thumbnail['name']){
			...
			if(in_array($extension, $allowed_files)){
				...
				if($thumbnail['size'] < 2000000){
					...
					$_SESSION['edit-post'] = "counld't update post. Thumbnail size too big. Should be less than 2mb";
				}
			}else{
				$_SESSION['edit-post'] = "counld't update post thumbnail should be pn, jpeg or jpg";
			}
		}
	}

	if($_SESSION['edit-post']){
		//redirect to manager form page if form was invalid 
		...
		//set thumbnail name is a new one was uploaded, else keep old thumbnail name 
