...
?>
	...
	<section class="dashboard">
		...
		<?php elseif(isset($_SESSION["edit-post"])): //show if add post was successful?>
		...
		<div class="conteiner dashboard__conteiner">
			...
			<aside>
				<ul>
					...
					<li>
						<a href="index.php" class="active"><img src="images/publish.png"><h5>Manage Posts</h5></a>
					</li>
				...
				<table>
					...
					<tbody>
						<?php while($post = mysqli_fetch_assoc($posts)): ?>
							<!--get category title f each post from categories table-->
							<?php 
