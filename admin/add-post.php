...
$title = $_SESSION['add-posts-data']['title'] ?? null;
$body = $_SESSION['add-posts-data']['body'] ?? null;

// delete form data session
unset($_SESSION['add-posts-data']);
?>
	...
	<section class="form__section">
		...
		<form action="<?= ROOT_URL ?>admin/add-posts-logic.php" enctype="multipart/form-data" method="POST">
			...
			<textarea rows="10" name="body" placeholder="Text"><?= $body ?></textarea>
